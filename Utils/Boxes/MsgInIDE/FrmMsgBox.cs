...
namespace IDE;
public partial class FrmMsgBox : UIForm
{
    ...
    public FrmMsgBox(MsgType type, string markdownText, Form form)
    {
        InitializeComponent();
        CurrentMsgType = type;
    ...
    public FrmMsgBox(Exception ex, Form form, MsgType type = MsgType.Error)
    {
        InitializeComponent();
        CurrentException = ex;
        CurrentMsgType = type;
